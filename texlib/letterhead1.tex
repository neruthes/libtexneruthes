...
\usepackage{paralist,enumitem,varwidth,indentfirst}
...
\graphicspath{ {/home/neruthes/DEV/ntexlibs/pic/} {node_modules/libtexneruthes/pic} }
...
\newcommand{\lettersignature}[2]{
    ...
    \fboxsep=0pt
    \hfill
    \begin{minipage}{\lettersignaturewidth+0.2pt}
        \parskip=8pt%
        #1\par
    \end{minipage}\par
    \vskip 1.5em
...
\newcommand{\letterfooterfont}[0]{\fontspec[Ligatures=TeX]{NewComputerModern10}\CJKfontspec{FandolSong}}
